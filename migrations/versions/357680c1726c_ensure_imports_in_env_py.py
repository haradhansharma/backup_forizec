...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('OWNER', 'USER', name='userroleenum', native_enum=False), nullable=True),
    ...
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('priority', sa.Enum('LOW', 'MID', 'HIGH', 'CRITICAL', name='priorityenum', native_enum=False), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'REVIEWED', 'IMPLEMENTED', 'ACTIONED', 'LIVE', name='compliencestatusenum', native_enum=False), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['service_id'], ['services.id'], name=op.f('fk_policies_service_id_services')),
    ...
    with op.batch_alter_table('user_invitations', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_user_invitations_invited_by'), ['invited_by'], unique=False)
    ...
    sa.ForeignKeyConstraint(['policy_id'], ['policies.id'], name=op.f('fk_policy_acceptances_policy_id_policies')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_policy_acceptances_user_id_users')),
    ...
    with op.batch_alter_table('policy_acceptances', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_policy_acceptances_policy_id'), ['policy_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_policy_acceptances_user_id'), ['user_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['policy_id'], ['policies.id'], name=op.f('fk_procedures_policy_id_policies')),
    ...
    sa.ForeignKeyConstraint(['procedure_id'], ['procedures.id'], name=op.f('fk_activity_logs_procedure_id_procedures')),
    ...
    with op.batch_alter_table('activity_logs', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_activity_logs_procedure_id'), ['procedure_id'], unique=False)
    ...
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['procedure_id'], ['procedures.id'], name=op.f('fk_checklist_items_procedure_id_procedures')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_checklist_items'))
    )
    with op.batch_alter_table('checklist_items', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_checklist_items_procedure_id'), ['procedure_id'], unique=False)

    op.create_table('compliance_schedule',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('title', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('due_date', sa.Date(), nullable=False),
    sa.Column('assigned_to', sa.Integer(), nullable=True),
    sa.Column('status', sa.Enum('PENDING', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', name='taskstatusenum', native_enum=False), nullable=True),
    sa.Column('priority', sa.Enum('LOW', 'MID', 'HIGH', 'CRITICAL', name='priorityenum', native_enum=False), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('completed_at', sa.DateTime(), nullable=True),
    sa.Column('related_policy_id', sa.Integer(), nullable=True),
    sa.Column('related_procedure_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['assigned_to'], ['users.id'], name=op.f('fk_compliance_schedule_assigned_to_users')),
    sa.ForeignKeyConstraint(['related_policy_id'], ['policies.id'], name=op.f('fk_compliance_schedule_related_policy_id_policies')),
    sa.ForeignKeyConstraint(['related_procedure_id'], ['procedures.id'], name=op.f('fk_compliance_schedule_related_procedure_id_procedures')),
    ...
    with op.batch_alter_table('compliance_schedule', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_compliance_schedule_assigned_to'), ['assigned_to'], unique=False)
        batch_op.create_index(batch_op.f('ix_compliance_schedule_id'), ['id'], unique=False)
        batch_op.create_index(batch_op.f('ix_compliance_schedule_related_policy_id'), ['related_policy_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_compliance_schedule_related_procedure_id'), ['related_procedure_id'], unique=False)
    ...
    sa.ForeignKeyConstraint(['policy_id'], ['policies.id'], name=op.f('fk_documents_policy_id_policies')),
    sa.ForeignKeyConstraint(['procedure_id'], ['procedures.id'], name=op.f('fk_documents_procedure_id_procedures')),
    ...
    with op.batch_alter_table('documents', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_documents_procedure_id'), ['procedure_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_documents_uploaded_by'), ['uploaded_by'], unique=False)

    op.create_table('procedure_acceptances',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('procedure_id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    sa.Column('accepted_at', sa.DateTime(), nullable=True),
    sa.Column('accepted', sa.Boolean(), nullable=True),
    sa.Column('comments', sa.Text(), nullable=True),
    sa.ForeignKeyConstraint(['procedure_id'], ['procedures.id'], name=op.f('fk_procedure_acceptances_procedure_id_procedures')),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name=op.f('fk_procedure_acceptances_user_id_users')),
    ...
    with op.batch_alter_table('procedure_acceptances', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_procedure_acceptances_procedure_id'), ['procedure_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_procedure_acceptances_user_id'), ['user_id'], unique=False)
    ...
    sa.Column('related_policy_id', sa.Integer(), nullable=True),
    sa.Column('related_procedure_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['related_policy_id'], ['policies.id'], name=op.f('fk_risks_related_policy_id_policies')),
    sa.ForeignKeyConstraint(['related_procedure_id'], ['procedures.id'], name=op.f('fk_risks_related_procedure_id_procedures')),
    ...
    with op.batch_alter_table('risks', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_risks_related_policy_id'), ['related_policy_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_risks_related_procedure_id'), ['related_procedure_id'], unique=False)
